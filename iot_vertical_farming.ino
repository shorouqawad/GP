...
//DHT Sensor;
uint8_t DHTPin = 39; //connected to GPIO 39 (Analog ADC1)
...
void loop()
{
    ...
    {
        set_data_double_firebase(sensor_reading_path +"/plant_id1/air_temperature",Humidity);
        set_data_double_firebase(sensor_reading_path +"/plant_id1/air_humidity",Temperature);
    }
    //----------------------------------------------
